                ...
                <div className="about_brand-img   order-2 mx-auto relative max-md:my-10 w-full pt-5">
                  <div className="relative group w-[90.4%] h-[336px] md:w-[377px] lg:w-[405px] xl:w-[494px]   md:h-[408px] xl:h-[568px]  mx-auto">
                    ...
                    <div className="relative z-10 mx-auto  w-full h-full ">
                      ...
                      {/* hover:bg-[#F18B1CD9] */}
                      <div
                        className={`service_img  bg-[#F18B1CE5] capitalize  flex justify-center items-center flex-col gap-6 md:gap-10 xl:gap-[70px]  opacity-0 group-hover:opacity-100  transition-opacity delay-75 z-50	duration-300 ease-in-out  absolute w-[81.8%]  left-1/2 right-1/2 transform  top-0 bottom-0 ${
                          currentLanguage === "ar"
                            ? "translate-x-[50%]"
                            : "-translate-x-[50%]"
                        }`}
                ...
                <div className="about_brand-img lg:order-1  order-1 mx-auto relative max-md:my-10 w-full pt-5">
                  <div className="relative group w-[90.4%] h-[336px] md:w-[377px] lg:w-[405px] xl:w-[494px]   md:h-[408px] xl:h-[568px]  mx-auto">
                    ...
                    <div className="relative z-10 mx-auto  w-full h-full ">
                      ...
                      {/* hover:bg-[#F18B1CD9] */}
                      <div
                        className={`service_img bg-[#F18B1CE5] z-50   flex justify-center items-center flex-col gap-6 md:gap-10 xl:gap-[70px]  opacity-0 group-hover:opacity-100  transition-opacity  delay-75	duration-300 ease-in-out  absolute w-[81.8%]  left-1/2 right-1/2 transform  top-0 bottom-0 ${
                          currentLanguage === "ar"
                            ? "translate-x-[50%]"
                            : "-translate-x-[50%]"
                        }`}
